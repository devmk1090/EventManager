    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(InDetailActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        categoryData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(InDetailActivity.this, 3);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("")) {
                    ...
                    Toast.makeText(getApplicationContext(), "받은 돈 내역이 수정되었습니다.", Toast.LENGTH_SHORT).show();
